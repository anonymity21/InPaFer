...
public class TraceMapService {
    ...
    public boolean traceMap(Set<String> allDetelteLine) {
        ...
        String traceFileName = Constant.Record +
                patchFile.getSubject().getName() + "/" + patchFile.getSubject().getId() + "/" + Constant.INSTRUMENT_LINE_DIR + patchFile.getPatchName() + Constant.INSTRUMENT_LINE_SEPARATORINIT;
        ...
        try {
            ...
            String traceFinalFile = traceFileName + Constant.MAPTRACE;
            ...
            while (diffLine != null) {
                ...
                if (diffLine.startsWith("---") || diffLine.startsWith("+++")) {
                    ...
                    // @@ -166,10 +166,10 @@
                    patchedLine = Integer.valueOf(diffLine.split(",")[0].split("-")[1]);
                    previousLine = patchedLine;
