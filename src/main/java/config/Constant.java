...
public class Constant {
    ...
    public static String DUMPER_HOME = HOME + "/src/main/java/auxiliary/";
    ...
    public static String CorrectPatch = CorrectPatchInfo + "correct_patches/";
    public static String Correct_Modification = CorrectPatchInfo + "nc_correct_modification";
