package patchfilter.perspectives;
...
public class TestPerspective implements IPerspectiveFactory {
	...
	private void addViews() {
		...
		topLeft.addView("patchfilter.views.TraceView");
		...
		/*IFolderLayout bottomLeft =
				factory.createFolder(
					...
					0.5f,
					"topLeft");
		bottomLeft.addView("patchfilter.views.PatchView");*/
		...
		bottom.addView("patchfilter.views.SampleView");
